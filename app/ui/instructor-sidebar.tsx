...
const navSections = [
  {
    ...
    items: [
      ...
      { Icon: MegaphoneIcon, label: "Announcements", href: "/dashboard/announcements" },
  ...
  },
  {
    label: "OPERATIONS",
    items: [
      { Icon: BookIcon, label: "Instructor Log", href: "/dashboard/instructor-log" },
      { Icon: LayersIcon, label: "Floor / Station", href: "/dashboard/floor-station" },
      { Icon: CartIcon, label: "Borrow", href: "/dashboard/borrow" },
      { Icon: ClipboardCheckIcon, label: "Borrow Approvals", href: "/dashboard/borrow-approvals" },
    ],
  },
  {
    label: "MY STUFF",
    items: [
      { Icon: ListIcon, label: "My List", href: "/dashboard/my-list" },
    ],
  },
];
    ...
    >
      ...
      <div className="flex items-center gap-3 px-5 pt-6 pb-5">
        ...
        <div>
          ...
          <p className="text-xs" style={{ color: "#9e9e9e" }}>Instructor</p>
        </div>
      </div>
      ...
      <div className="px-5 pb-5 pt-3 border-t" style={{ borderColor: "#2a4a2d" }}>
        <div className="mb-3">
          <p className="text-white text-sm font-semibold">Demo Instructor</p>
          <p className="text-xs mt-0.5" style={{ color: "#7aa87e" }}>instructor@demo.chtm</p>
          <span
